...
class ContourPalette : public DG::Palette, public DG::PanelObserver
{
public:
	static bool         HasInstance();
	static void         CreateInstance();
	static ContourPalette& GetInstance();
...
private:
	static GS::Ref<ContourPalette> s_instance;
