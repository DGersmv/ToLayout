...
class GroundPalette : public DG::Palette, public DG::PanelObserver
{
public:
	static bool         HasInstance();
	static void         CreateInstance();
	static GroundPalette& GetInstance();
...
private:
	static GS::Ref<GroundPalette> s_instance;
