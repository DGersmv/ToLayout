...
class SendXlsPalette : public DG::Palette, public DG::PanelObserver
{
public:
	static bool          HasInstance();
	static void          CreateInstance();
	static SendXlsPalette& GetInstance();
...
private:
	static GS::Ref<SendXlsPalette> s_instance;
