...
class OrganizeLayoutsPalette : public DG::Palette, public DG::PanelObserver
{
public:
	static bool           HasInstance();
	static void           CreateInstance();
	static OrganizeLayoutsPalette& GetInstance();
...
private:
	static GS::Ref<OrganizeLayoutsPalette> s_instance;
