...
class IdLayersPalette : public DG::Palette, public DG::PanelObserver
{
public:
	static bool            HasInstance();
	static void            CreateInstance();
	static IdLayersPalette& GetInstance();
...
private:
	static GS::Ref<IdLayersPalette> s_instance;
